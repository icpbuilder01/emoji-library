...
export class Backend implements backendInterface {
    ...
    async getEmojisByCategory(arg0: string): Promise<Array<Emoji>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEmojisByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchEmojis(arg0: string): Promise<Array<Emoji>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchEmojis(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
